        ...
        [
            ...
            },
            {
                ...
                "answers": {
                            ...
                            "3": "Да – есть риск не списать долги по завершению процедуры банкротства. Оценку этих рисков лучше доверить специалистам компании Банкротам.НЕТ»"
                            }
            },
            {
                "n" : 9,
                ...
                "type" : "variant",
                "answers": {
                            "1": "Да имеются – Поздравляем, Вы можете избавиться от непосильных долгов через процедуру банкротства физических лиц. Но для этого Вам понадобится финансовый управляющий, без которого пройти процедуру невозможно. Благо, найти его проще простого в компании «Банкротам.НЕТ». Мы не только предоставим Вам финансового управляющего, но и обеспечим полное юридическое сопровождение в рассрочку. Рассчитать цену банкротства.",
                            "2": "Нет, не помню – Рекомендуем Вам обратиться в компанию Банкротам.НЕТ» для более тщательного анализа ситуации. В 99% мы сможем и Вам помочь списать долги через процедуру банкротства."
                            }
            }
        ]
    }
        ...
        if ($numberQuestion == $value->n) {
            echo '<p class="quiz__subtitle">
                  ...
                  <form action="index.php?toquestion" class="quiz__form" method="post">
                    ...
                    <input type="hidden" name="questions" id="questions" value="9">
